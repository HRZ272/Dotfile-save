...
class NotesApp(tk.Tk):
    ...
    def _right(self, p):
        ...
        def _draw_tc(e=None):
            ...
            tc.create_window(w//2, h//2, window=self.e_title, anchor='center',
                             width=w-24, height=24, tags='tw')
        ...
        def _draw_bc(e=None):
            ...
            bc.create_window(w//2, h//2, window=self.txt, anchor='center',
                             width=w-12, height=h-12, tags='bw')
